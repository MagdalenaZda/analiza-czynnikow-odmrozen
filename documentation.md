...
* **Male Dominance:** Men account for **85% of all hospitalizations**, indicating significantly higher exposure to extreme low temperatures in this group.
* **The Mortality Paradox:** Despite lower hospitalization volume, the **mortality rate for women is 22%**, compared to 13.5% for men.
* **Diagnosis Type by Gender:** Women are predominantly diagnosed with **Hypothermia (T68)**—a systemic condition with higher fatality risks. Men more frequently suffer from **Frostbite with tissue necrosis (T34)**—a localized injury posing a high risk of permanent disability.
